...
if (!token) {
    ...
    console.error('   2. Set it as an environment variable in your hosting platform (Railway, Render, etc.)');
    console.error('   3. Export it: export DISCORD_BOT_TOKEN=your_token_here');
    console.error('');
    console.error('🔐 SECURITY: Never hardcode tokens in your code!');
    console.error('   Always use environment variables to keep your tokens secure.');
    process.exit(1);
}
